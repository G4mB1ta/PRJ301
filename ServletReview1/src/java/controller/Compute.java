...
public class Compute extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet Compute at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    } 
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try {
                ...
                out.print("You must input two integers");
                return;
            }
            
            if (x == 0 || y == 0) {
                out.print("You must input an integer #0");
                return;
            } 
            
            if (c.equals("+")) {
                out.print("%d".formatted( x+y));
            } else if (c.equals("/")) {

                int t = x / y;
                out.print("%d".formatted( t));
            }
        }
    }
